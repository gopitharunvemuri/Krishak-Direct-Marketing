...
if($_SERVER["REQUEST_METHOD"]=="POST"){
  ...
  $conn=mysqli_connect($servername,$root,$password,$dbname);
   ...
   $sql = "SELECT id,contact FROM second";
...
$sql="INSERT INTO second  VALUES ('$id','$username','$password','$contact','$state','$districts','$village')";  
